...
from random import shuffle # ordoneaza numerele intro lista aleatoriu
my_list = [1, 3, 56, 4]
shuffle(my_list)
print(my_list)

from random import randint # da un numar aleatoriu dintrun interval
print(randint(12,200))
