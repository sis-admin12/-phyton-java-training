...
returned_value_1 = greeting_depends_on_gender('Jackis', 'male')
returned_value_2 = greeting_depends_on_gender('Janena', 'female')
returned_value_3 = greeting_depends_on_gender('Jaaaaa', 'cmale')
...
print(get_odd_number_list(2, 12))
